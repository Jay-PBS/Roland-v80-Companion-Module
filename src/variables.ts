...
export function UpdateVariableDefinitions(self: ModuleInstance): void {
	self.setVariableDefinitions([
		...
		{ variableId: 'split1', name: 'Split 1 Vertical – active (ON/OFF)' },
		{ variableId: 'split2', name: 'Split 2 Horizontal – active (ON/OFF)' },
		...
		{ variableId: 'ftb', name: 'Fade To Black – ENGAGED, CLEAR or UNKNOWN' },
		{ variableId: 'ftb_fading', name: 'Fade To Black – fade in progress (ON/OFF)' },
